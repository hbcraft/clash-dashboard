  ...
  return (
    ...
    >
      ...
      <div className="my-3 flex">
        ...
        <span className="font-mono">{`${props.connection.metadata?.sourceIP}:${props.connection.metadata?.sourcePort}`}</span>
      </div>
      <div className="my-3 flex">
      ...
      <div className="my-3 flex">
        ...
        <span className="font-mono">
          {props.connection.rule &&
            `${props.connection.rule}${
              props.connection.rulePayload &&
              ` :: ${props.connection.rulePayload}`
            }`}
        </span>
      </div>
